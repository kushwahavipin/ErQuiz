...
public class StartGame extends AppCompatActivity {
    ...
    public void nextQuestion(View view) {
       ...
       // btn2.setBackgroundColor(Color.parseColor("#2196f3"));
        ...
        btn1.setBackground(getDrawable(R.drawable.backgroun_wall));
        btn2.setBackground(getDrawable(R.drawable.backgroun_wall));
        btn3.setBackground(getDrawable(R.drawable.backgroun_wall));
        btn4.setBackground(getDrawable(R.drawable.backgroun_wall));
    ...
    public void answerSelected(View view) {
        ...
        view.setBackground(getDrawable(R.drawable.color_btn_1));
